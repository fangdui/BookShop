...
<div class="address">
    <div class="wrapper clearfix"><a href="/indexselect">首页</a><span>/</span>
        ...
        <a href=" " class="on">搜索商品</a>


    </div>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">方队家的书</h3></div>
</div><!----------------proList------------------------->
<ul class="proList wrapper clearfix">
    <c:forEach var="sp" items="${splist}">
        <li><a href="/selectproductdetail?id=${sp.product_id}">
            <dl>
                <dt><img src="images/product/${sp.product_filename}"></dt>
                <dd>【方队书店】${sp.product_name}</dd>
                <dd>￥${sp.product_price}.00</dd>
            </dl>
        </a></li>
    </c:forEach>
</ul><!----------------mask------------------->
