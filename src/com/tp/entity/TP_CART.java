...
public class TP_CART {
    ...
    public TP_CART(int cart_id, String cart_p_filename, String cart_p_name, int cart_p_price, int cart_quantity, int cart_p_stock, int cart_p_id, String cart_u_id, int cart_valid) {
        this.cart_id = cart_id;
        this.cart_p_filename = cart_p_filename;
        this.cart_p_name = cart_p_name;
        this.cart_p_price = cart_p_price;
