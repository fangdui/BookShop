...
public class TP_PRODUCT {
    ...
    public TP_PRODUCT(int product_id, String product_name, String product_description, int product_price, int product_stock, int product_fid, int product_cid, String product_filename) {
